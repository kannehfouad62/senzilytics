# Google Play submission worksheet — Senzilytics 1.2.0
...
Do not declare audio, precise/coarse location, contacts, health, financial data, purchases or advertising identifiers for version 1.2.0 unless the final binary or tenant-configured forms actually collect them. Camera, photo/video and document evidence are present and must be represented in the final Data safety answers.
