...
type Tab = "home" | "workspace" | "capture" | "inspections" | "audits" | "auditServices" | "research" | "risks" | "governance" | "complianceDocuments" | "controlledWork" | "assetContractors" | "hygieneHealth" | "chemicalEnvironmental" | "esg" | "behaviorAssurance" | "regulatory" | "executive" | "administration" | "actions" | "settings";
...
function SettingsScreen({ workspace, pending, signingOut, releaseStatus, systemHealth, verifiedAt, onRefreshDiagnostics, onEnablePush, onLogout }: { workspace: MobileBootstrap; pending: number; signingOut: boolean; releaseStatus: MobileReleaseStatus | null; systemHealth: MobileSystemHealth | null; verifiedAt: number | null; onRefreshDiagnostics: () => void; onEnablePush: () => void; onLogout: () => void }) {
