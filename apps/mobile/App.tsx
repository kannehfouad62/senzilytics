...
function SenzilyticsApp() {
  ...
  return (
    <SafeAreaView style={styles.app}>
      ...
      {tab === "auditServices" && <AuditServicesScreen workspace={workspace} online={online} onBack={() => setTab("workspace")} onRefresh={refreshWorkspace} onNotice={setNotice} onOpenPath={openWorkspacePath} />}
  ...
  return (
    ...
    >
      ...
      <Text style={styles.muted}>
        Your tenant and role determine what appears here. Operational pages open
        in Senzilytics&apos; responsive secure workspace; authorized native field
