...
type Tab = "home" | "workspace" | "capture" | "inspections" | "audits" | "risks" | "governance" | "controlledWork" | "assetContractors" | "hygieneHealth" | "chemicalEnvironmental" | "esg" | "behaviorAssurance" | "actions" | "settings";
  ...
  return (
    <SafeAreaView style={styles.app}>
      ...
      <View style={styles.tabs}>
        ...
        <TabButton active={tab === "capture" || tab === "inspections" || tab === "audits" || tab === "risks" || tab === "governance" || tab === "controlledWork" || tab === "assetContractors" || tab === "hygieneHealth" || tab === "chemicalEnvironmental" || tab === "esg" || tab === "behaviorAssurance"} label="Field" badge={pending || undefined} onPress={() => setTab("capture")} />
