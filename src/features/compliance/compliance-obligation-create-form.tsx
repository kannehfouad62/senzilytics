...
import { createComplianceObligation } from "@/features/compliance/actions";
...
export function ComplianceObligationCreateForm({
  children,
  forms,
}: {
  children: ReactNode;
  ...
  return (
    <form
      action={action}
      aria-busy={pending}
      className={`mt-8 space-y-6 rounded-3xl border border-white/10 bg-white/5 p-7 transition ${
