  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <button
        ...
        className={`fixed top-4 z-50 hidden rounded-xl border border-cyan-400/20 bg-slate-950/95 p-3 text-cyan-200 shadow-xl transition hover:bg-cyan-400/10 lg:block ${expanded ? "left-[17.25rem]" : "left-5"}`}
        title={
