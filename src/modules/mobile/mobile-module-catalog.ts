...
const modules: readonly MobileModuleDefinition[] = [
  ...
  { key: "predictive-intelligence", label: "Predictive Intelligence", description: "Explainable leading indicators, exposure trends, evidence, and qualified review.", href: "/intelligence/predictive", category: "COMMAND", permission: PermissionKey.VIEW_PREDICTIVE_INTELLIGENCE },
  { key: "management-reviews", label: "Management Reviews", description: "Enterprise leadership review cycles, evidence snapshots, decisions, approvals, and controlled board packs.", href: "/management-reviews", category: "COMMAND", permission: PermissionKey.VIEW_EXECUTIVE_REVIEWS },
  ...
  { key: "research", label: "Research & Analytics", description: "Assigned sample units, encrypted offline interviews, and governed field synchronization.", href: "/research", category: "COMMAND", permission: PermissionKey.VIEW_RESEARCH, nativeCapability: "RESEARCH_FIELDWORK", nativePermission: PermissionKey.COLLECT_RESEARCH_DATA },
  ...
  { key: "emergency", label: "Emergency Preparedness", description: "Controlled plans, scenarios, contacts, exercises, response activations, and after-action improvements.", href: "/emergency", category: "SAFETY", permission: PermissionKey.VIEW_EMERGENCY_PREPAREDNESS },
  { key: "business-continuity", label: "Business Continuity", description: "Continuity plans, impact analyses, recovery objectives, dependencies, exercises, disruptions, and improvements.", href: "/business-continuity", category: "SAFETY", permission: PermissionKey.VIEW_BUSINESS_CONTINUITY },
  { key: "sif", label: "SIF Prevention", description: "Serious injury and fatality signals and critical controls.", href: "/assurance/sif", category: "ASSURANCE", permission: PermissionKey.VIEW_SIF_INTELLIGENCE, nativeCapability: "SIF_ASSURANCE_FIELD" },
