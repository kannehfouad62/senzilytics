...
import { Building2, FolderOpen, PackageCheck } from "lucide-react";
...
export default async function ResearchClientPortalPage() {
  ...
  return <div>
    ...
    <p className="mt-2 max-w-3xl text-slate-400">This controlled workspace exposes only projects explicitly assigned to your client portal account. Internal working data and unapproved outputs remain hidden.</p><Link href="/research/client-portal/deliveries" className="mt-5 inline-flex items-center gap-2 rounded-xl border border-cyan-300/20 bg-cyan-300/[.05] px-4 py-3 text-sm font-semibold text-cyan-200"><PackageCheck size={17}/>Open secure delivery room</Link>
