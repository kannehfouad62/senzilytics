...
export default async function DocumentCenterPage({
    ...
    const status = isEnumValue(DocumentStatus, filters.status)
      ? filters.status
      : undefined;
      ...
      <div>
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-3xl text-slate-400">
            Search, download, archive, restore, and manage documents
...
/>
                    ...
                    {document.status === DocumentStatus.ARCHIVED && (
                      <form action={restoreDocumentAction}>
                        ...
                        <button
                          type="submit"
                          className="inline-flex items-center gap-2 rounded-xl border border-green-400/20 bg-green-400/10 px-4 py-2 text-sm font-semibold text-green-300 transition hover:bg-green-400/20"
                        >
                          <RotateCcw size={16} />
                          Restore
                        </button>
            ...
            {documents.length === 0 && (
              <div className="p-12 text-center">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Upload a document from an incident or adjust your
                  search filters.
                </p>
              </div>
            )}
  ...
  function StatCard({
    ...
    return (
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-xl">
        <div className="rounded-2xl bg-cyan-400/10 p-3 text-cyan-300 w-fit">
          <Icon size={22} />
        </div>
