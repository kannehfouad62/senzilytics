import {
    addInspectionChecklistQuestion,
    addInspectionChecklistSection,
    deleteInspectionChecklistQuestion,
    toggleInspectionChecklistTemplate,
  } from "@/features/inspections/inspection-checklist.actions";
  ...
  export default async function InspectionChecklistTemplatePage({
    params,
  }: {
    params: Promise<{
      id: string;
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <Field label="Question type">
                          <select
                            name="questionType"
                            defaultValue={
                              InspectionQuestionType.COMPLIANCE
                            }
                            className={
                              inputClass
                            }
