import { createAuditChecklistTemplate } from "@/features/audits/audit-checklist.actions";
...
export default async function AuditChecklistsPage() {
  ...
  const templates =
    await prisma.auditChecklistTemplate.findMany({
      where: {
        organizationId,
      },
      include: {
      ...
      <div className="flex flex-wrap items-start justify-between gap-5">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-slate-400">
            ...
            audit checklists for consistent
