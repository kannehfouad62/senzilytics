...
export default async function AuditProgramsPage() {
  ...
  return <div>
    ...
    <div className="mt-6 flex flex-wrap items-start justify-between gap-5"><div><p className="flex items-center gap-2 text-sm text-cyan-300"><Target size={16} /> Audit Governance</p><h1 className="mt-2 text-4xl font-bold">Audit Programs</h1><p className="mt-2 max-w-3xl text-slate-400">Manage risk-based audit portfolios, organizational scope, standards, ownership, and recurring coverage.</p></div><Link href="/audits/programs/new" className="inline-flex items-center gap-2 rounded-2xl bg-cyan-300 px-5 py-3 text-sm font-semibold text-slate-950"><Plus size={17} /> Create Program</Link></div>
