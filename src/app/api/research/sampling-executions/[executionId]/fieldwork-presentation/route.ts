...
export async function GET(
  ...
  const slides: SlideElement[][] = [
    ...
    [
      ...
      item(0.8, 1.05, 11, 0.3, `Integrity policy: <${policy.minimumInterviewMinutes} min · >${policy.maximumSyncDelayHours}h sync · >${policy.maximumLocationAccuracyM}m GPS uncertainty · ${policy.locationClusterRadiusM}m proximity`, 11, false, "94A3B8"),
      item(
        0.8,
        1.6,
        11,
